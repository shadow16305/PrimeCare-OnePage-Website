  ...
  return (
    <Fragment>
      <div className="container mx-auto flex flex-col items-center pt-10 pb-10 lg:pb-40 gap-10">
        ...
        <div className="flex flex-col items-center lg:items-start lg:flex-row lg:relative gap-10 lg:gap-0 lg:px-[300px]">
          <div className="flex flex-col justify-center items-center lg:items-start text-center lg:text-start px-8 py-6 lg:py-10 gap-10 rounded-3xl bg-midnightGreen w-[340px] lg:w-[456px] lg:h-[404px] lg:absolute lg:top-[45%] lg:left-0">
            <h4 className="text-white">Appointment</h4>
            <p className="text-[14px] lg:text-[24px] font-semibold text-white font-['Quicksand'] lg:w-[342px]">
          ...
          <div className="flex flex-col justify-center p-5 bg-[#E8EDEC] rounded-3xl gap-8 w-[340px] lg:w-[456px] lg:h-[404px] lg:absolute lg:top-[10%] lg:right-0">
            ...
            <ul>
              <li className="before:content-[''] before:absolute before:translate-y-[-50%] before:top-1/2 before:rounded-3xl before:w-[9px] before:h-[9px] before:left-0 before:bg-black relative ps-5">
                <p className="text-[14px] lg:text-[24px] font-semibold text-black font-['Quicksand'] ">
