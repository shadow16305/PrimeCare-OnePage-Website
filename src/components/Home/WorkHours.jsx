    ...
    <Fragment>
      <div className="container mx-auto flex flex-col items-center pt-10 pb-10 lg:pb-40 gap-10">
        ...
        <div className="flex flex-col items-center lg:items-start lg:flex-row lg:relative gap-10 lg:gap-0 lg:px-[300px] lg:mt-6">
          <div className="flex flex-col justify-center items-center lg:items-start text-center lg:text-start px-8 py-6 lg:py-6 gap-10 rounded-[60px] bg-midnightGreen w-[340px] lg:w-[400px] lg:h-[320px] lg:absolute lg:top-[45%] lg:left-0">
          ...
          <img
            ...
            alt=""
          />
          <div className="flex flex-col justify-center p-5 px-8 bg-[#E8EDEC] rounded-[60px] gap-8 w-[340px] lg:w-[400px] lg:h-[320px] lg:absolute lg:top-[-10%] lg:right-0">
