  ...
  return (
    <Fragment>
      <div className="container mx-auto flex flex-col lg:flex-row lg:justify-center gap-12 py-12">
        <div className="flex flex-col items-center lg:items-start text-center lg:text-start gap-10 justify-center">
          <span className="text-midnightGreen text-[16px] bg-[#F4F6F7] p-2 w-[200px] rounded-md text-center font-bold">
            FACILITIES WE HAVE
          </span>
          <h2 className="lg:max-w-[483px]">
            What Exactly Facilities We Provide
          </h2>
          <p className="lg:max-w-[483px]">
            It is a broad discipline that includes various branches and
            specialties aimed at promoting health and well-being.
          </p>
          <div>
            <button className="px-6 py-3 bg-midnightGreen text-white text-xl font-['DM_Sans'] rounded-3xl hover:bg-[#328495] transition-[0.25s]">
              CALL US
            </button>
          </div>
        </div>
